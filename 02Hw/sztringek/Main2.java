public class Main2
{
    ...
    private static String notBad(String s)
    {
        ...
        // Ha a 'bad' a 'not' után következik
    ...
    {
        int aHalf = a.length() / 2 + a.length() % 2;
        int bHalf = b.length() / 2 + b.length() % 2;
        
        return a.substring(0, aHalf) + b.substring(0, bHalf) + a.substring(aHalf) + b.substring(bHalf);
    }
